...
public class Book implements Parcelable {
     ...
     * @param urlImageCover - (String) URL address of an image cover i.e.: "http://books.google.com
     *                      /books/(...)"
     ...
     */
    public Book(String bookTitle, String authorName, String urlImageCover, Double bookPrice, String
            currency, String languageCode, String buyLink) {
