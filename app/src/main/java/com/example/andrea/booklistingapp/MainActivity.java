package com.example.andrea.booklistingapp;
...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<Book>> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Check that the keyboard is hidden at the beggining
        this.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);

        /*
         * At the beginning check the connection with internet and save result to (boolean)
        ...
        bookListView = (GridView) findViewById(R.id.list);
        ...
        // Search button
        ImageView mSearchButton = (ImageView) findViewById(R.id.search_button);
        ...
        if (isConnected) {
            ...
            Log.i(LOG_TAG, "INTERNET connection status: " + String.valueOf(false) +
                    ". Sorry, no internet - no data :(");
        ...
        // Set an item click listener on the Search ImageButton, which sends a request to
        ...
        imm.hideSoftInputFromWindow(mSearchViewField.getWindowToken(), 0);
    ...
    public void checkConnection(ConnectivityManager connectivityManager) {
        ...
        if (activeNetwork != null &&
            ...
            Log.i(LOG_TAG, "INTERNET connection status: " + String.valueOf(true) +
